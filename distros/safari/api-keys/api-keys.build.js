...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  async function getStore() {
    const data2 = await storage.get({ [STORAGE_KEY]: DEFAULT_STORE });
    return { ...DEFAULT_STORE, ...data2[STORAGE_KEY] };
  }
  async function setStore(store2) {
    await storage.set({ [STORAGE_KEY]: store2 });
  }
  ...
  async function saveApiKey(id, label, secret) {
    ...
    await setStore(store2);
    return store2.keys[id];
  }
  async function deleteApiKey(id) {
    const store2 = await getStore();
    delete store2.keys[id];
    await setStore(store2);
  }
  async function listApiKeys() {
    const store2 = await getStore();
    return Object.values(store2.keys).sort(
      (a, b) => a.label.toLowerCase().localeCompare(b.label.toLowerCase())
    );
  }
  async function setSyncEnabled(enabled) {
    const store2 = await getStore();
    store2.syncEnabled = enabled;
    await setStore(store2);
  }
  async function isSyncEnabled() {
    const store2 = await getStore();
    return store2.syncEnabled;
  }
  async function updateStoreSyncState(syncStatus, eventId = null, relayCreatedAt = null) {
    const store2 = await getStore();
    store2.syncStatus = syncStatus;
    if (eventId !== null) store2.eventId = eventId;
    if (relayCreatedAt !== null) store2.relayCreatedAt = relayCreatedAt;
    await setStore(store2);
  }
  ...
  module_default.data("apiKeyManager", () => ({
    // State
    keys: [],
    newLabel: "",
    newSecret: "",
    ...
    async publishToRelay() {
      try {
        const store2 = await getApiKeyStore();
        const result = await api.runtime.sendMessage({
          kind: "apikeys.publish",
          payload: { keys: store2.keys }
        });
        if (result.success) {
...
//# sourceMappingURL=data:application/json;base64,
